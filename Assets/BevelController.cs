...
public class BevelController : MonoBehaviour {
    ...
    void Start () {
        ...
        name = physicsManager.AddObject("bevel", normal, transform.localScale.y, transform.localScale.z);
        physicsManager.SetObject(name, normal, transform.localScale.y, transform.localScale.z);
    }
